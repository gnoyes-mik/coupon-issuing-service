...
class CouponIssueServiceTest extends TestConfig {
    ...
    @Test
    @DisplayName("쿠폰 발급 내역이 존재한다면 예외를 발생시킨다")
    ...
    void issue_1() {
        ...
        // then
        Optional<Coupon> couponOptional = couponJpaRepository.findById(coupon.getId());
        Assertions.assertTrue(couponOptional.isPresent());

        Coupon couponResult = couponOptional.get();
    ...
    @Test
    @DisplayName("발급 수량에 문제가 있다면 예외를 발생시킨다")
    void issue_2() {
        // given
        long userId = 1L;
        Coupon coupon = Coupon.builder()
    ...
    @Test
    @DisplayName("발급 기한에 문제가 있다면 예외를 발생시킨다")
    void issue_3() {
        // given
        long userId = 1L;
        Coupon coupon = Coupon.builder()
    ...
    @Test
    @DisplayName("중복 발급 검증에 문제가 있다면 예외를 발생시킨다")
    void issue_4() {
        // given
        long userId = 1L;
        Coupon coupon = Coupon.builder()
    ...
    @Test
    @DisplayName("쿠폰이 존재하지 않는다면 예외를 발생시킨다")
    void issue_5() {
        // given
        long userId = 1L;
        long couponId = 1L;
